            ...
            <Table>
                <tbody>
                    ...
                    <TableRow>
                        ...
                        <ContentCell>
                            <Strong>팀장</Strong> 정채원<br/>
                            강소이 권경은 김명찬 김민정 김준희 김태영 박소빈 송현지 윤지혜 이나영
                        </ContentCell>
                    </TableRow>
                    <TableRow>
                        <RoleCell>세션기획팀</RoleCell>
                        <ContentCell>
                            <Strong>팀장</Strong> 황연우<br/>
                            권은비 김서연 남가빈 박지원 변혜진 손정윤 윤원준 차묘정 허준서 현유영
                        </ContentCell>
                    </TableRow>
                    <TableRow>
                        <RoleCell>홍보기획팀</RoleCell>
                        <ContentCell>
                            <Strong>팀장</Strong> 김지안<br/>
